...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-cente">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="index.html">Food Delights<span>Restaurant</span></a></h1>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative text-center text-lg-start" data-aos="zoom-in" data-aos-delay="100">
      <div class="row">
        <div class="col-lg-8">
          <h1>Welcome to <span>Food Delights</span></h1>
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>Ganeshnagar,Tadepalligudem</p>
              </div>
              ...
              <div class="email">
                ...
                <h4>Email:</h4>
                <p>Fooddelightsrestaurant@gmail.com</p>
              </div>
        ...
        <div class="row">
          ...
          <div class="container">
            ...
            <div class="credits">
              ...
              Designed by <a href="https://bootstrapmade.com/">Project-Batch(18CSEC014)</a>
            </div>
          </div>
  </footer><!-- End Footer -->
